...
+(UIViewController*)BuildScreenforStack:(nullable MSObjectStack*)stack withNavController:(nullable UINavigationController*)navcontroller screen:(MSLifeLoggerScreen)screen {
    ...
    switch (screen) {
        ...
        case MSLifeLoggerScreenAbout: {
            MSMobileCorePresenter *presenter = MSLifeLoggerAboutPresenter.new;
            MSLifeLoggerAboutViewController* aboutView = [[MSLifeLoggerAboutViewController alloc] initWithPresenter:presenter stack:stack];
