...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:((MSLifeLoggerAboutPresenter*)self.presenter).buttonCloseText style:UIBarButtonItemStyleDone target:self action:@selector(close:)];
