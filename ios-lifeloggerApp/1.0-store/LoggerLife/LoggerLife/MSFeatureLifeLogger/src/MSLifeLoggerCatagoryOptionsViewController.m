...
-(void) onSelectExportLog:(id)sender {
    ...
    UIViewController* controller = [MSFeatureLifeLogger BuildScreenforStack:stack withNavController:self.navigationController screen:MSLifeLoggerScreenExportCatagory];
