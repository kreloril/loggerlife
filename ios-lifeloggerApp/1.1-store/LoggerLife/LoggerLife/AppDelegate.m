...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
   ...
   [[GADMobileAds sharedInstance] startWithCompletionHandler:nil];
    ...
    [LIFELOGGER_CURRENT_DATABASE initCatagories];

    
    UINavigationController* navControllerCenter = (UINavigationController*)[MSFeatureScreenBuilder BuildScreenforStack:nil withNavController:nil screen:MSLifeLoggerScreenCenterView];
    
    UINavigationController* navControllerLeft =  (UINavigationController*)[MSFeatureScreenBuilder BuildScreenforStack:nil withNavController:nil screen:MSLifeLoggerScreenLeftView];
