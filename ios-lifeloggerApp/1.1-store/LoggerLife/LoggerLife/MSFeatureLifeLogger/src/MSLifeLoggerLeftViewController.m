...
-(void)refreshTable {
    ...
    self.tableViewItems = LIFELOGGER_CURRENT_DATABASE.arrayOfCatagories;
    ...
    if (self.tableViewItems.count > 0) {
        ...
        for (int i = 0; i < self.tableViewItems.count;i++) {
         ...
         [LIFELOGGER_CURRENT_DATABASE changeCatagory:self.tableViewItems[foundInteger]];
...
-(void)onSelectOptions:(id)sender {
    ...
    if (LIFELOGGER_CURRENT_DATABASE.activeCatagory) {
    ...
    [controller addAction:[UIAlertAction actionWithTitle:@"Edit Current Category" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        UINavigationController* nav = (UINavigationController*)[MSFeatureScreenBuilder BuildScreenforStack:stack withNavController:nil screen:MSLifeLoggerScreenAddEditCatagory];
    ...
    [controller addAction:[UIAlertAction actionWithTitle:@"Change Category Order" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        MSObjectStack* stack = [MSObjectStack new];
        UINavigationController* nav = (UINavigationController*)[MSFeatureScreenBuilder BuildScreenforStack:stack withNavController:nil screen:MSLifeLoggerScreenChangeCatagoryOrder];
    ...
    [controller addAction:[UIAlertAction actionWithTitle:@"About" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        MSObjectStack* stack = [MSObjectStack new];
        UINavigationController* nav = (UINavigationController*)[MSFeatureScreenBuilder BuildScreenforStack:stack withNavController:nil screen:MSLifeLoggerScreenAbout];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   // [tableView deselectRowAtIndexPath:indexPath animated:NO];
    ...
    [LIFELOGGER_CURRENT_DATABASE changeCatagory:cat];
